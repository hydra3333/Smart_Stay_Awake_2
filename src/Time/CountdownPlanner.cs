// File: src/Smart_Stay_Awake_2/Time/CountdownPlanner.cs
...
namespace Smart_Stay_Awake_2.Time
{
    ...
    internal static class CountdownPlanner
    {
        ...
        public static int GetBaseCadenceMs(int remainingSeconds)
        {
            ...
            Trace.WriteLine("Smart_Stay_Awake_2: CountdownPlanner: WARNING - No cadence band matched, using 1s fallback");
            return 1_000;
        }
            ...
            if (remainingSeconds >= AppConfig.HARD_CADENCE_SNAP_TO_THRESHOLD_SECONDS)
            {
                ...
                if (phaseSeconds != 0)
                {
                    ...
                    if (snapMs < baseCadenceMs)
                    {
                        ...
                        Trace.WriteLine("Smart_Stay_Awake_2: CountdownPlanner: Snap-to applied: remaining=" + remainingSeconds + "s, phase=" + phaseSeconds + "s, snap=" + snapMs + "ms");
                    }
                }
            }
